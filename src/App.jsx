      ...
      {activeCoachTab === 'insight' && (
        <div className="space-y-4">
                  ...
                  <div className="grid grid-cols-3 gap-2">
                    ...
                    <div className="bg-[#F0FDFA] rounded-xl px-3 py-2">
                      ...
                      <p className="text-sm font-black text-[#0F172A]">
                        {knowledge.running?.currentPace ? formatDashboardTime(knowledge.running.currentPace / 60) + '/km' : '—'}
                      </p>
                    </div>
                    <div className="bg-[#F0FDFA] rounded-xl px-3 py-2">
          ...
          <div className="rounded-3xl border border-[#DCE3EA] bg-white overflow-hidden">
            <div className="flex items-center justify-between px-4 py-3 bg-[#F8FAFC] border-b border-[#DCE3EA]">
              <div className="flex items-center gap-2">
                ...
                <p className="text-[10px] text-[#64748B] uppercase font-bold tracking-wider">Alerts</p>
                {alerts.length > 0 && (
                  <span className="text-[9px] font-bold bg-[#FEF3C7] text-[#92400E] px-2 py-0.5 rounded-full">{alerts.length}</span>
                )}
              </div>
              <button
                onClick={() => setActiveCoachTab('alerts')}
                className="text-[10px] font-bold text-[#14B8A6] hover:text-[#0F766E] transition-colors flex items-center gap-1"
              >
            ...
            <div className="px-4 py-3">
              {alerts.length === 0 ? (
                ...
                <div className="flex items-start gap-2">
                  ...
                  <p className="text-xs text-[#78350F]">{alerts[0]}</p>
                </div>
              )}
            </div>
          </div>
          ...
          <div className="rounded-3xl border border-[#DCE3EA] bg-white overflow-hidden">
            <div className="flex items-center justify-between px-4 py-3 bg-[#F8FAFC] border-b border-[#DCE3EA]">
              <div className="flex items-center gap-2">
                ...
                <p className="text-[10px] text-[#64748B] uppercase font-bold tracking-wider">Weekly Review</p>
              </div>
              <button
                onClick={() => setActiveCoachTab('report')}
                className="text-[10px] font-bold text-[#14B8A6] hover:text-[#0F766E] transition-colors flex items-center gap-1"
              >
            ...
            <div className="px-4 py-3">
              {coachReport ? (
                <p className="text-xs text-[#64748B]">Report ready for review. Click "Open Report" to see the full weekly summary.</p>
              ) : (
                <p className="text-xs text-[#64748B]">Not enough data to generate a report yet. Log more workouts.</p>
              )}
            </div>
          </div>
          ...
          <div className="rounded-3xl border border-[#DCE3EA] bg-white overflow-hidden">
            <div className="flex items-center justify-between px-4 py-3 bg-[#F8FAFC] border-b border-[#DCE3EA]">
              <div className="flex items-center gap-2">
                ...
                <p className="text-[10px] text-[#64748B] uppercase font-bold tracking-wider">Generate Next Block</p>
              </div>
              <button
                onClick={() => setActiveCoachTab('pipeline')}
                className="text-[10px] font-bold text-[#14B8A6] hover:text-[#0F766E] transition-colors flex items-center gap-1"
              >
            ...
            <div className="px-4 py-3">
              <p className="text-xs text-[#64748B]">Create a new Training Block using AI. Head to the Pipeline tab to review and generate.</p>
            </div>
          </div>
          ...
          <div className="rounded-3xl border border-[#DCE3EA] bg-white overflow-hidden">
            ...
            >
              <div className="flex items-center gap-2">
                <BrainCircuit className="w-4 h-4 text-[#64748B]" />
                <p className="text-[10px] text-[#64748B] uppercase font-bold tracking-wider">Advanced Tools</p>
              </div>
              ...
              <div className="px-4 py-3 space-y-2">
                {aiRequest && (
                  <button
                    ...
                    className="w-full flex items-center justify-center gap-2 px-3 py-2.5 bg-[#8B5CF6] hover:bg-[#7C3AED] text-white text-[10px] font-bold rounded-xl transition-colors"
                  >
          ...
          {!knowledge && !coachInsight && !activeTrainingBlock && (
